...
List names = ['Abdullah Ali Azhar', 'Dwayne Johnson', 'Selena Gomez', 'Daniel Craig', 'Tom Cruise', 'Jennifer Lawrence', 'Tom Holland', 'Chris Evans', 'Jennifer Lopez',
  'Michael B. Jordan', 'Bradley Cooper', 'Will Smith', 'Jack Black'];
List searches = [5120000, 367000000, 388000000, 488000000, 369000000, 541000000, 618000000, 541000000, 610000000, 978000000, 192000000, 2230000000, 2080000000];
List images = ['Abdullah', 'johnson', 'gomez', 'craig', 'cruise', 'lawrence', 'holland', 'evans', 'lopez', 'michaelb', 'cooper', 'smith', 'jack'];

class HollywoodCompetitive extends StatefulWidget {
  static const String id = 'hollywood_competitive';
  @override
  _HollywoodCompetitiveState createState() => _HollywoodCompetitiveState();
}


class _HollywoodCompetitiveState extends State<HollywoodCompetitive> {
  @override
