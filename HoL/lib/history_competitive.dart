...
List names = ['George Washington', 'Napoleon', 'Thomas Jeffeson', 'william shakespeare', 'Alexander The Great', 'Artistotle', 'Abraham Lincoln', 'Adolf Hitler'];
List searches = [3230000000, 2170000000 ,1830000000, 1380000000, 1140000000, 838000000, 133000000, 114000000];
List images = ['George Washington', 'Napoleon', 'Thomas Jeffeson', 'william shakespeare', 'Alexander The Great', 'Artistotle', 'Abraham Lincoln', 'Adolf Hitler'];


class HistoryCompetitive extends StatefulWidget {
  static const String id = 'history_competitive';
  @override
  _HistoryCompetitiveState createState() => _HistoryCompetitiveState();
}


class _HistoryCompetitiveState extends State<HistoryCompetitive> {
  @override
