...
List names = ['Bitcoin', 'Ethereum', 'Decentraland', 'XRP', 'Cardano', 'Terra', 'Polkadot', 'Axie Infinity', 'Binance coin', 'Litecoin'];
List searches = [855000000, 256000000, 14900000, 108000000, 82300000, 1210000000, 348000000, 16500000, 93000000, 130000000];
List images = ['Bitcoin', 'Ethereum', 'Decentraland', 'XRP', 'Cardano', 'Terra', 'Polkadot', 'Axie Infinity', 'Binance coin', 'Litecoin'];

class CryptoCompetitive extends StatefulWidget {
  static const String id = 'crypto_competitive';
  @override
  _CryptoCompetitiveState createState() => _CryptoCompetitiveState();
}


class _CryptoCompetitiveState extends State<CryptoCompetitive> {
  @override
