...
List names = ['PewDiePie', 'KSI', 'Logan Paul', 'Sidemen', 'MrBeast', 'Dude Perfect', 'Ryan Higa', 'David Dobrik', 'Liza Koshy', 'Zach King'];
List searches = [67400000, 60400000, 287000000, 12000000, 30900000, 1560000000, 1760000, 5610000, 4130000, 38900000];
List images = ['PewDiePie', 'KSI', 'Logan Paul', 'Sidemen', 'MrBeast', 'Dude Perfect', 'Ryan Higa', 'David Dobrik', 'Liza Koshy', 'Zach King'];

class YoutubeCompetitive extends StatefulWidget {
  static const String id = 'youtube_competitive';
  @override
  _YoutubeCompetitiveState createState() => _YoutubeCompetitiveState();
}

class _YoutubeCompetitiveState extends State<YoutubeCompetitive> {
  @override
